...
from lrfoldercraft.index import duplicates, query, subset
from lrfoldercraft.index.scan import find_catalogs, scan
from lrfoldercraft.index.store import Index, IndexError_
from lrfoldercraft.index.volumes import BY_FINGERPRINT, BY_UUID, describe
...
def test_the_folder_tool_does_not_import_the_index():
    ...
    """
    code = (
        "import sys; import lrfoldercraft.cli, lrfoldercraft.planner, "
        "lrfoldercraft.executor, lrfoldercraft.folders; "
        "print([m for m in sys.modules if m.startswith('lrfoldercraft.index')])"
    )
