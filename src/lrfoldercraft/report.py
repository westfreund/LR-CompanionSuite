...
T = {
    ...
    "carried_vc": ("Virtual copies carried along", "Mitgeführte virtuelle Kopien"),
    ...
    "verification": ("Verification", "Prüfung"),
    "passed": ("passed", "bestanden"),
    "errors": ("Errors", "Fehler"),
    "rolled_back": ("Rolled back", "Zurückgesetzt"),
    ...
    "from_override": ("set explicitly", "ausdrücklich gesetzt"),
    "from_operator": ("chosen by you", "von Ihnen gewählt"),
