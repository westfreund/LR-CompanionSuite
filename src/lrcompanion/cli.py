...
def build_parser() -> argparse.ArgumentParser:
    ...
    from .metasearch.cli import add_parser as add_index_parser
...
def cmd_tui(args: argparse.Namespace) -> int:
    try:
        ...
        print(
            ...
            "    python3 -m pip install 'lr-companion-suite[tui]'\n"
            "or\n"
...
def cmd_gui(args: argparse.Namespace) -> int:
    try:
        ...
        print(
            ...
            "    python3 -m pip install 'lr-companion-suite[gui]'\n"
            "or\n"
...
def _cmd_index(args: argparse.Namespace) -> int:
    ...
    from .metasearch.cli import cmd_index
