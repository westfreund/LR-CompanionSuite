...
__codename__ = "Zu zweit"

#: Human readable revision tag, e.g. ``r1.0.0 (2026-08-22)``.
REVISION = "r{v} ({d})".format(v=__version__, d=__build_date__)

#: The suite, and the tools inside it. One version covers all of them: they
#: ship together, and two numbers to keep in step would be one too many.
SUITE_NAME = "LR-CompanionSuite"
SUITE_SLUG = "lr-companion-suite"
SUITE_URL = "https://gitlab.com/andy-freund/LR-CompanionSuite"

#: Tool one: the folder reorganiser, which is where this began.
APP_NAME = "LR-FolderCraft"
APP_SLUG = "lr-foldercraft"
APP_URL = SUITE_URL

#: Tool two: the index across libraries.
METASEARCH_NAME = "LR-MetaSearch"
METASEARCH_SLUG = "lr-metasearch"
