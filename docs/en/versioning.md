...
```console
$ lrfc --version
LR-FolderCraft r3.0.1 (2026-08-23) - Daybreak
```

```
LR-FolderCraft r3.0.1 (2026-08-23) - Daybreak      <- every report header
```

```
LR-FolderCraft — r3.0.1 (2026-08-23) - build 2026-08-22    <- TUI header
```

```
2026-08-22 16:26:31 | INFO | Revision r3.0.1 (2026-08-23) | version 1.0.0 | build date 2026-08-22
```
...
```bash
git tag -a v3.0.1 -m "LR-FolderCraft r1.0.0"
