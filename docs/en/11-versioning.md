...
```console
$ lrfc --version
LR-FolderCraft r7.1.0 (2026-08-23) - Gedaechtnis
```

```
LR-FolderCraft r7.1.0 (2026-08-23) - Gedaechtnis      <- every report header
```

```
LR-FolderCraft — r7.1.0 (2026-08-23) - build 2026-08-23    <- TUI header
```

```
2026-08-22 16:26:31 | INFO | Revision r7.1.0 (2026-08-23) | version 5.0.0 | build date 2026-08-23
```
...
```bash
git tag -a v7.1.0 -m "LR-FolderCraft r7.1.0"
