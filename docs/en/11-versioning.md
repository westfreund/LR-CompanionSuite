...
```console
$ lrfc --version
LR-FolderCraft r14.0.1 (2026-08-23) - Umschrift
```

```
LR-FolderCraft r14.0.1 (2026-08-23) - Umschrift      <- every report header
```

```
LR-FolderCraft — r14.0.1 (2026-08-23) - build 2026-08-23    <- TUI header
```

```
2026-08-22 16:26:31 | INFO | Revision r14.0.1 (2026-08-23) | version 5.0.0 | build date 2026-08-23
```
...
```bash
git tag -a v14.0.1 -m "LR-FolderCraft r14.0.1"
