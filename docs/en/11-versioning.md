...
```console
$ lrfc --version
LR-FolderCraft r13.0.3 (2026-08-23) - Laufakte
```

```
LR-FolderCraft r13.0.3 (2026-08-23) - Laufakte      <- every report header
```

```
LR-FolderCraft — r13.0.3 (2026-08-23) - build 2026-08-23    <- TUI header
```

```
2026-08-22 16:26:31 | INFO | Revision r13.0.3 (2026-08-23) | version 5.0.0 | build date 2026-08-23
```
...
```bash
git tag -a v13.0.3 -m "LR-FolderCraft r13.0.3"
